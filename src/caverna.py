...
"""
    ...
    def cria_caverna(self):
        ...
        self.tunel = {
            'tunel_%d_d' % par_ordenado:
            Tunel(self.html, "tunel_%d_d" % par_ordenado, self.sala,
...
"""
    ...
    def cria_camara(self):
        ...
        self.div.text = "Caverna '_' %s" % self.nome
...
"""
    ...
    def cria_tunel(self):
        ...
        [self.cria_entrada(self.caverna.camara["camara_d" % saida])
         for saida in self.par_ord]
        self.div.style.backgroundSize = 'cover'
        self.div.style.backgroundImage = 'url(%s)' % CAVEZ
        self.div.style.width = 1000
        self.div.style.height = 800
        self.div.text = "Tunel %s" % self.nome
        self.div <= self.passagem
        self.cria_saida()
        return self
